...
class ThreemaGw extends utils.Adapter {
    ...
    async onReady() {
        ...
        */
        ...
        this.setState("info.lastresponse", { val: "adapter is now running", ack: true });
        ...
        */
        ...
        //await this.setState("info.credits", { val: -999, ack: true });
        //await this.setState("info.lastresponse", { val: "adapter is now running", ack: true });
