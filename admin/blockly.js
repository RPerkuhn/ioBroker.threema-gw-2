...
Blockly.Words["threema-gw_tooltip"] = {
    en: "Send a threema message via threema gateway",
    de: "Sende ein E-Mail",
    ru: "??????? threema-gw",
};
Blockly.Words["threema-gw_help"] = {
    en: "https://github.com/ioBroker/ioBroker.threema-gw/blob/master/README.md",
    de: "https://github.com/ioBroker/ioBroker.threema-gw/blob/master/README.md",
    ru: "https://github.com/ioBroker/ioBroker.threema-gw/blob/master/README.md",
};
...
Blockly.Blocks["threema-gw"] = {
    init: function () {
        ...
        this.appendValueInput("TEXT").setCheck("String").appendField(Blockly.Words["threema-gw_text"][systemLang]);
...
Blockly.JavaScript["threema-gw"] = function (block) {
    ...
    return "sendTo('threema-gw" + dropdown_instance + "', 'send', " + text + ");\n" + logText;
};
